...
#     --model gemini/gemini-3-flash-preview \
#     --preprocess all \
#     --alphabet assets/dictionaries/samples/Evenki-Russian/evenki_alphabet.txt \
#     --intro assets/dictionaries/samples/Evenki-Russian/introduction \
#     --ocr-text assets/dictionaries/samples/Evenki-Russian/mathpix \
#     --input-image assets/dictionaries/samples/Evenki-Russian/snippets \
#     --output assets/dictionaries/samples/Evenki-Russian/outputs/2-stage \
#     --stage 1 \
#     --overwrite